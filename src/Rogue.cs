    ...
    public class Rogue
    {
        ...
        public static void createFlensingStrike()
        {
            ...
            var flensing_debuff = Helpers.CreateBuff(
                ...
                Helpers.CreateContextRankConfig(ContextRankBaseValueType.CustomProperty, customProperty: library.Get<BlueprintUnitProperty>("a9d8d3c40dab4e8e8d92112cea65dc65")),// (HarmonyLib.AccessTools.Field(Type.GetType("CallOfTheWild.NewMechanics.SneakAttackDiceGetter"), "Blueprint").GetValue(null) as Lazy<BlueprintUnitProperty>).Value), //  CallOfTheWild.NewMechanics.SneakAttackDiceGetter.Blueprint.Value),
