...
namespace FumisCodex.NewComponents
{
    ...
    public class AddPermanentWeaponBuff : BuffLogic, IAreaActivationHandler, IGlobalSubscriber
    {
        public override void OnFactActivate()
        {
            ...
            {
                flag = base.Owner.Body.PrimaryHand.RemoveItem(true);
            }
            if (flag)
                ...
                Main.DebugLog($"AddPermanentWeaponBuff cannot remove item: {base.Owner.Body.PrimaryHand.Item?.Name}");
        }
